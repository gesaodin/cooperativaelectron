...
<head>
    ...
    <script type="text/javascript" src="<?php echo __JSVIEW__ ?>estatico/planCorporativo.js"></script>
    <script type="text/javascript" src="<?php echo __JSVIEW__ ?>view/panelPlan.js"></script>
