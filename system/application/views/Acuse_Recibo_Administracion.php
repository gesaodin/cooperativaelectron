...
<head>
	...
	<script type="text/javascript" src="<?php echo __JSVIEW__ ?>view/acuse.js"></script>
...
<body>
	...
	<div id="medio" >	
		...
		<h2 class="demoHeaders">	Acuse Recibo Administraci&oacute;n</h2><br>
		<h3>Usuario Conectado: <?php echo $this->session->userdata('usuario'); ?> Fecha: <?php echo date("Y/m/d"); ?></h3><br><br>
																
				<?php $this->load->view("Acuse_Recibo_Administracion/crear.php");?>
