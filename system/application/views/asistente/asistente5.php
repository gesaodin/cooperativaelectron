...
<head>
	...
	<script type="text/javascript" src="<?php echo __JSVIEW__ ?>view/asistente5.js"></script>
</head>
<body>
	<div id="cabecera"><br>
	...
	<div id="medio" style="width: 80%;">	
		...
		<img src="<?php echo __IMG__ ?>menu/paso5.png">
		<input type="hidden" value="<?php echo $cert?>" id="txtCert" />
		<input type="hidden" value="<?php echo $fact?>" id="txtFact" />
		<?php echo $msj;?>
		<div id="listar" style="width: 100%"></div>
	</div>
</body>
</html>