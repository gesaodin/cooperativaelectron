...
<head>	
	...
	<script type="text/javascript" src="<?php echo __JSVIEW__ ?>view/asistente3.js"></script>
</head>
<body>
	<div id="cabecera"><br>
...
<div id='lista' style="display: none">
	<table border=1 cellspacing=0 celladding=0 style="	color: #333333;	width: 90%; border: 1px solid #CCCCCC;"><tr><td>PLAN DE CREDITO</td>
		...
		<select onchange="Seleccion_Mes(this.value);crea_combos(this.value);Asignar(this.value);Validar(this);Calcular_Total(this);" 
