...
<head>
	...
	<script type="text/javascript" src="<?php echo __JSVIEW__ ?>estatico/gv_usuario.js"></script>
	<script type="text/javascript" src="<?php echo __JSVIEW__ ?>view/usuario.js"></script>
...
<body>
	...
	<div id="medio" >	
		...
		<h2 class="demoHeaders">Panel de Usuarios</h2><br>
