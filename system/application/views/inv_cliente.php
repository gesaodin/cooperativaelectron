...
<head>
	...
	<script type="text/javascript" src="<?php echo __JSVIEW__ ?>view/inv_cliente.js"></script>
...
<body>
	...
	<div id="medio" >
		...
		<div id="msj_alertas"></div>
			<h2 class="demoHeaders">Entregar Mercancia Cliente</h2><br>
			<h3>Usuario Conectado: <?php echo $this->session->userdata('usuario'); ?> Fecha: <?php echo date("Y/m/d"); ?></h3><br>
				 
			    						    							    	
					<div>																		
							<?php $this->load->view("inventario/ent_cliente");?>
					</div>
