<form name="frmListar" method="POST" action='<?php echo base_url(); ?>index.php/cooperativa/Listar_Inventariop'>	
		<div class="boton">
...
action='<?php echo base_url(); ?>index.php/cooperativa/Guardar_Inventariop' >
