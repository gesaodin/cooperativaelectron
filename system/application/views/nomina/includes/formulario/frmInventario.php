...
<table width="680" border="0" cellspacing="3" cellpadding="0"
	...
	<tr>
		...
		<td colspan="3">			
				<div class="ui-widget">
					<input type="text" name="txtProveedores" id="txtProveedores" class="inputxt" style="width:500px"
					value='<?php echo $Proveedor ?>'/>
					<input type="hidden" name="txtProveedores1" id="txtProveedores1" class="inputxt" style="width:500px"
					value='<?php echo $Proveedor ?>'/>
		...
		<td colspan="3">			
				<div class="ui-widget">
					<input type="text" name="txtEquipos" id="txtEquipos" class="inputxt" style="width:500px"
					value='<?php echo $Equipo ?>'/>
					<input type="hidden" name="txtEquipos1" id="txtEquipos1" class="inputxt" style="width:500px"
					value='<?php echo $Equipo ?>'/>
				</div>	
		</td>
	</tr>	
	...
	<tr>		
		<tr>	
			...
			<td align="left" class="formulario"  valign="top">
			...
			<td>Porcentaje Contado: </td><td><input name="txtPorcentaje" type="text"  id="txtPorcentaje" style="width: 55px;" class="inputxt"
			value='<?php echo $Porcentaje ?>'/>&nbsp;%</td>	
	</tr>
	<tr>
