...
|
|	http://example.com/
| $config['base_url']	= "http://200.75.121.178/cooperativa-electron";
*/

//$config['base_url']	= $IP_SERVER_DYNAMIC."/cooperativa-electron";
$config['base_url']="http://200.82.139.180/cooperativa-electron";
$config['base_url2']="http://200.82.139.180/cooperativaelectron";
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
|
*/
$config['sess_cookie_name']		= 'Electron-Connect';
...
define("__TITLE__", "Sistema de Control de Prestamos");
...
define("__LIBRARY__", $config['base_url'] . "/system/application/libraries/");
